  ...
  return (
    <ScreenWrapper>
      <View style={styles.container}>
        ...
        <Text style={styles.subtitle}>Your payment was successful and your order is now confirmed.</Text>

        <View style={styles.summaryCard}>
          <Row label="Order ID" value={`#${order.id}`} />
          <Row label="Items" value={`${order.items.length}`} />
          <Row label="Total Paid" value={formatCurrency(order.total)} emphasize />
        </View>
